...
<details markdown="1">
  ...
  Clear out the `<input>` field's value after the user submits the new todo. Remember this is a controlled component. Refer to [React State](https://github.com/nrahul32/Study-Materials/blob/main/React/React_study_guide.md#react-state) if you need a quick refresher on how to manage a component’s state.
</details>
